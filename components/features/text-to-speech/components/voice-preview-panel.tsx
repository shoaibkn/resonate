...
import { Download, Loader, Pause, Play, Redo, Undo } from "lucide-react";
...
export default function VoicePreviewPanel({
  ...
  audioUrl: string;
  voice: VoicePreviewPanelProps | null;
  text: string;
}) {
  ...
  return (
    <div className="h-full gap-8 flex-col border-t my-auto">
      {/* Header */}
